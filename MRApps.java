...
public class MRApps extends Apps {
	...
	static final String STAGING_CONSTANT = ".staging";
	static Path getStagingAreaDir(Configuration conf, String user) {
	  return new Path(conf.get(MRJobConfig.MR_AM_STAGING_DIR,
	      MRJobConfig.DEFAULT_MR_AM_STAGING_DIR) // "/tmp/hadoop-yarn/staging";
	      + Path.SEPARATOR + user + Path.SEPARATOR + STAGING_CONSTANT);
	  ///tmp/hadoop-yarn/staging/shadoop/.staging
